...
["_isolate_helper", "dart:_isolate_helper", , H, {
  ...
  IsolateNatives__processWorkerMessage: function(sender, e) {
    ...
    switch (t1.$index(msg, "command")) {
      case "start":
        ...
        t2._add$1(t2, new H._IsolateEvent(context, new H.IsolateNatives__processWorkerMessage_closure(entryPoint, args, message, isSpawnUri, replyTo), "worker-start"));
  ...
  _NativeJsSendPort: {
    ...
    send$1: function(_, message) {
      ...
      t2 = t2.events;
      t2._add$1(t2, new H._IsolateEvent(isolate, new H._NativeJsSendPort_send_closure(t1, this, shouldSerialize), t3));
    },
    $eq: function(_, other) {
      var t1;
      if (other == null)
...
["dart.async", "dart:async", , P, {
  ...
  _BroadcastStreamController: {
    "": "Object;_onListen<,_onCancel<,_next@,_previous@",
    get$_isFiring: function() {
  ...
  _SyncBroadcastStreamController: {
    ...
    _sendData$1: function(data) {
      ...
      if (t1.get$_next() === this) {
        ...
        subscription = this._next;
        subscription._async$_add$1(subscription, data);
        this._state = this._state & 4294967293;
        if (this._next === this)
          this._callOnCancel$0();
        return;
  ...
  _SyncBroadcastStreamController__sendData_closure: {
    ...
    call$1: function(subscription) {
      subscription._async$_add$1(subscription, this.data_1);
    },
    $signature: function() {
  ...
  _AsBroadcastStreamController: {
    ...
    }, "addError$1", "call$2", "call$1", "get$addError", 2, 2, 16, 3],
    close$0: [function(_) {
      var t1 = this._state;
      if ((t1 & 4) === 0 && (t1 & 2) !== 0) {
...
["dart.collection", "dart:collection", , P, {
  ...
  _LinkedHashMap: {
    ...
    containsValue$1: function(value) {
      var t1 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterable(this), [H.getTypeArgumentByIndex(this, 0)]);
  ...
  SplayTreeMap_containsValue_visit: {
    "": "Closure:22;this_0,value_1,initialSplayCount_2",
...
["dart.dom.html", "dart:html", , W, {
  ...
  Node: {
    ...
    text$0: function($receiver) {
      return this.textContent.call$0();
    },
    contains$1: function(receiver, other) {
...
["dart.dom.indexed_db", "dart:indexed_db", , P, {
  ...
  Cursor: {
    ...
    }, "next$0", "call$1", "call$0", "get$next", 0, 2, 10, 3],
    "%": ";IDBCursor"
  },
  CursorWithValue: {
    "": "Cursor;",
  ...
  Database: {
    ...
    createObjectStore$2$autoIncrement: function($receiver, name, autoIncrement) {
      return this.createObjectStore$3$autoIncrement$keyPath($receiver, name, autoIncrement, null);
    },
  ...
  _completeRequest_closure: {
    "": "Closure:13;request_0,completer_1",
    call$1: function(e) {
      var t1, t2;
  ...
  ObjectStore__cursorStreamFromResult_closure: {
    "": "Closure:13;request_0,autoAdvance_1,controller_2",
    call$1: function(e) {
      var cursor, t1;
...
["game", "game.dart", , Q, {
  ...
  Attack: {
    "": "Action;",
    execute$2: function(player, words) {
      var t1, firstWord, secondWord, thirdWord, fourthWord, t2;
      t1 = J.getInterceptor$asx(words);
      firstWord = t1.$index(words, 0);
      secondWord = t1.$index(words, 1);
      thirdWord = J.$gt$n(t1.get$length(words), 2) ? t1.$index(words, 2) : "";
      fourthWord = J.$gt$n(t1.get$length(words), 3) ? t1.$index(words, 3) : "";
      if (J.$gt$n(t1.get$length(words), 2)) {
        t2 = J.getInterceptor(thirdWord);
        if (!t2.$eq(thirdWord, "with"))
          return "What do you want to " + H.S(firstWord) + " with?";
        else {
          if (t2.$eq(thirdWord, "with"))
            if (J.$gt$n(t1.get$length(words), 3)) {
              t1 = player.inventory;
              t1 = t1._validKey$1(fourthWord) === true && J.$eq(t1._splay$1(fourthWord), 0);
            } else
              t1 = false;
          else
            t1 = false;
          if (t1)
            return "You " + H.S(firstWord) + " the " + H.S(secondWord) + " with the " + H.S(fourthWord) + " \n            without any noticeable effect.";
          else
            return "You need to " + H.S(firstWord) + " with an object in your inventory.";
        }
      } else
        return "You need to " + H.S(firstWord) + " an object with something \n          in your inventory.";
    }
  },
  Move: {
    "": "Action;",
    execute$2: function(player, words) {
      var t1, firstWord, secondWord, directions, t2;
      t1 = J.getInterceptor$asx(words);
      firstWord = t1.$index(words, 0);
      secondWord = J.$gt$n(t1.get$length(words), 1) ? t1.$index(words, 1) : "";
      directions = ["down", "e", "east", "n", "ne", "north", "northeast", "northwest", "nw", "s", "se", "sw", "south", "southeast", "southwest", "up", "w", "west"];
      t1 = J.getInterceptor(secondWord);
      if (!t1.$eq(secondWord, "")) {
        t2 = player.location.get$exits();
        if (t2._validKey$1(secondWord) === true && J.$eq(t2._splay$1(secondWord), 0) && !J.$eq(firstWord, "climb")) {
          t1 = player.location.get$exits();
          t1 = J.get$location$x(t1.$index(t1, secondWord));
          player.location = t1;
          return J.text$0$x(t1);
        } else {
          t2 = J.getInterceptor(firstWord);
          if (t2.$eq(firstWord, "enter") || t2.$eq(firstWord, "exit"))
            return "You can't " + H.S(firstWord) + " " + H.S(secondWord) + " here.";
          else if (t2.$eq(firstWord, "climb"))
            if (t1.$eq(secondWord, "up") || t1.$eq(secondWord, "down"))
              return "You can't " + H.S(firstWord) + " here.";
            else if (C.JSArray_methods.contains$1(directions, secondWord))
              return "You can't " + H.S(firstWord) + " to the " + H.S(secondWord) + " here.";
            else
              return "You can't " + H.S(firstWord) + " the " + H.S(secondWord) + " here.";
          else
            return "You can't " + H.S(firstWord) + " " + H.S(secondWord) + " here.";
        }
      } else {
        t1 = player.location.get$exits();
        if (t1._validKey$1(firstWord) === true && J.$eq(t1._splay$1(firstWord), 0)) {
          t1 = player.location.get$exits();
          t1 = J.get$location$x(t1.$index(t1, firstWord));
          player.location = t1;
          return J.text$0$x(t1);
        } else if (C.JSArray_methods.contains$1(directions, firstWord))
          return "You can't go " + H.S(firstWord) + " here.";
      }
    }
  },
  Examine: {
    "": "Action;",
    execute$2: function(player, words) {
      var t1, firstWord, secondWord, inanimates;
      t1 = J.getInterceptor$asx(words);
      firstWord = t1.$index(words, 0);
      secondWord = t1.$index(words, 1);
      inanimates = player.location.get$inanimates();
      if (inanimates._validKey$1(secondWord) === true && J.$eq(inanimates._splay$1(secondWord), 0))
        return C.JSString_methods.$add("You " + H.S(firstWord) + " the " + H.S(secondWord) + ":<br />", inanimates.$index(inanimates, secondWord).get$examineText());
      else
        return "There is no " + H.S(secondWord) + " to " + H.S(firstWord) + ".";
    }
  },
  Take: {
    "": "Action;",
    execute$2: function(player, words) {
      var t1, firstWord, secondWord, inanimates, t2, item;
      t1 = J.getInterceptor$asx(words);
      firstWord = t1.$index(words, 0);
      secondWord = t1.$index(words, 1);
      inanimates = player.location.get$inanimates();
      if (inanimates._validKey$1(secondWord) === true && J.$eq(inanimates._splay$1(secondWord), 0)) {
        t1 = inanimates.$index(inanimates, secondWord);
        t2 = J.getInterceptor(t1);
        if (typeof t1 === "object" && t1 !== null && !!t2.$isTakeable) {
          item = inanimates.$index(inanimates, secondWord);
          item.set$taken(true);
          player.inventory.putIfAbsent$2(secondWord, new Q.Take_execute_closure(item));
          return "You " + H.S(firstWord) + " the " + H.S(secondWord) + ".";
        } else
          return "You are unable to " + H.S(firstWord) + " the " + H.S(secondWord) + ".";
      } else
        return "There is no " + H.S(secondWord) + " to " + H.S(firstWord) + ".";
    }
  },
  Take_execute_closure: {
    "": "Closure:11;item_0",
    call$0: function() {
      return this.item_0;
    }
  ...
  Player: {
    "": "Animate;hp,defense,inventory,currentAction,examine,take,attack,move,location",
    get$inv: function() {
      var sb, t1, t2, t3;
      sb = P.StringBuffer$("");
      sb.write$1("Inventory:<br />");
      t1 = this.inventory;
      t1.toString;
      if (H.setRuntimeTypeInfo(new P._SplayTreeValueIterable(t1), [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)])._map._count > 0)
        for (t1 = this.inventory, t1.toString, t1 = H.setRuntimeTypeInfo(new P._SplayTreeValueIterable(t1), [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]), t2 = t1._map, t3 = H.getTypeArgumentByIndex(t1, 1), t1 = H.setRuntimeTypeInfo(new P._SplayTreeValueIterator(t2, H.setRuntimeTypeInfo([], [P._SplayTreeNode]), t2._modificationCount, t2._splayCount, null), [H.getTypeArgumentByIndex(t1, 0), t3]), t1._SplayTreeIterator$1(t2, t3); t1.moveNext$0();) {
          t2 = C.JSString_methods.$add("&nbsp;&nbsp;", t1.get$current().get$examineText()) + "<br />";
    ...
    Player$1: function($location) {
      this.hp = 10;
      this.defense = 10;
      this.inventory = P.SplayTreeMap$(null, null, J.JSString, Q.Inanimate);
      this.examine = new Q.Examine();
      this.take = new Q.Take();
      this.attack = new Q.Attack();
      this.move = new Q.Move();
    }
  },
  Exit: {
    "": "Object;location>",
  ...
  Game: {
    "": "Object;view,player,store,currentLocation,location0,location1,location2,location3,location4,locations,commands",
    updateView$0: function() {
      var t1 = this.view;
      t1.set$text(t1, J.text$0$x(this.player.location));
      t1 = this.view;
      t1.set$title(t1, J.get$title$x(this.player.location));
    },
    evaluateCommand$1: function(words) {
      var t1, firstWord, t2;
      t1 = J.getInterceptor$asx(words);
      firstWord = t1.$index(words, 0);
      if (!J.$eq(J.$gt$n(t1.get$length(words), 1) ? t1.$index(words, 1) : "", "")) {
        t1 = J.getInterceptor(firstWord);
        if (t1.$eq(firstWord, "examine") || t1.$eq(firstWord, "read")) {
          t1 = this.player;
          t2 = t1.examine;
          t1.currentAction = t2;
          return t2.execute$2(t1, words);
        } else if (t1.$eq(firstWord, "take") || t1.$eq(firstWord, "get")) {
          t1 = this.player;
          t2 = t1.take;
          t1.currentAction = t2;
          return t2.execute$2(t1, words);
        } else if (t1.$eq(firstWord, "hit") || t1.$eq(firstWord, "attack")) {
          t1 = this.player;
          t2 = t1.attack;
          t1.currentAction = t2;
          return t2.execute$2(t1, words);
        } else if (t1.$eq(firstWord, "enter") || t1.$eq(firstWord, "exit") || t1.$eq(firstWord, "go") || t1.$eq(firstWord, "walk") || t1.$eq(firstWord, "run") || t1.$eq(firstWord, "climb") || t1.$eq(firstWord, "leave")) {
          t1 = this.player;
          t2 = t1.move;
          t1.currentAction = t2;
          return t2.execute$2(t1, words);
        }
      } else if (C.JSArray_methods.contains$1(["down", "e", "east", "n", "ne", "north", "northeast", "northwest", "nw", "s", "se", "sw", "south", "southeast", "southwest", "up", "w", "west"], firstWord)) {
        t1 = this.player;
        t2 = t1.move;
        t1.currentAction = t2;
        return t2.execute$2(t1, words);
        ...
        t1 = J.getInterceptor(firstWord);
        if (t1.$eq(firstWord, "i") || t1.$eq(firstWord, "inventory"))
          return this.player.get$inv();
        else if (t1.$eq(firstWord, "hp") || t1.$eq(firstWord, "health"))
          return "Health: " + H.S(this.player.hp);
        else if (t1.$eq(firstWord, "l") || t1.$eq(firstWord, "look") || t1.$eq(firstWord, "location") || t1.$eq(firstWord, "where"))
          return J.text$0$x(this.player.location);
        else if (t1.$eq(firstWord, "go") || t1.$eq(firstWord, "walk") || t1.$eq(firstWord, "run") || t1.$eq(firstWord, "exit") || t1.$eq(firstWord, "enter") || t1.$eq(firstWord, "climb"))
          return "Where do you want to " + H.S(firstWord) + "?";
        else if (t1.$eq(firstWord, "examine") || t1.$eq(firstWord, "take") || t1.$eq(firstWord, "get") || t1.$eq(firstWord, "read") || t1.$eq(firstWord, "attack") || t1.$eq(firstWord, "hit"))
          return "What do you want to " + H.S(firstWord) + "?";
        else if (t1.$eq(firstWord, "save"))
          return this.save$0();
        else if (t1.$eq(firstWord, "load"))
          return this.load$0(this);
        else
          return "I don't understand \"" + H.S(firstWord) + "\" in that context.";
      }
    },
    readyCommands$0: function() {
      return W.HttpRequest_getString("json/commands.json", null, null).then$1(new Q.Game_readyCommands_closure(this));
    },
    load$0: function(_) {
      var t1, data, t2, item, t3, element;
      t1 = this.store._gameData;
      data = t1.$index(t1, "save");
      P.print(data);
      t1 = this.player.inventory;
      t1._root = null;
      t1._count = 0;
      t1._modificationCount = t1._modificationCount + 1;
      for (t1 = J.getInterceptor$asx(data), t2 = J.get$iterator$ax(t1.$index(data, "inventory")); t2.moveNext$0();) {
        item = t2.get$current();
        this.player.inventory.putIfAbsent$2(J.$index$asx(item, 0), new Q.Game_load_closure(item));
      }
      t2 = this.player;
      t3 = this.locations;
      t2.location = t3.$index(t3, t1.$index(data, "currentLocation"));
      for (t1 = J.get$iterator$ax(t1.$index(data, "locations")); t1.moveNext$0();) {
        element = t1.get$current();
        t2 = this.locations;
        t3 = J.getInterceptor$asx(element);
        t2 = t2.$index(t2, t3.$index(element, 0)).get$inanimates();
        t2.$index(t2, t3.$index(element, 1)).set$taken(t3.$index(element, 2));
      }
      this.updateView$0();
      return "Game loaded.";
    },
    save$0: function() {
      var data, t1, inventory, t2, t3, item, t4, $location, inanimate;
      data = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      data.$indexSet(data, "inventory", []);
      t1 = this.player.inventory;
      t1.toString;
      inventory = H.setRuntimeTypeInfo(new P._SplayTreeKeyIterable(t1), [H.getTypeArgumentByIndex(t1, 0)]);
      for (t1 = inventory._tree, t2 = H.getTypeArgumentByIndex(inventory, 0), t3 = H.setRuntimeTypeInfo(new P._SplayTreeKeyIterator(t1, H.setRuntimeTypeInfo([], [P._SplayTreeNode]), t1._modificationCount, t1._splayCount, null), [t2]), t3._SplayTreeIterator$1(t1, t2); t3.moveNext$0();) {
        item = t3.get$current();
        t1 = data.$index(data, "inventory");
        t2 = this.player.inventory;
        t2 = t2.$index(t2, item).get$examineText();
        t4 = this.player.inventory;
        J.add$1$ax(t1, [item, t2, t4.$index(t4, item).get$locationText()]);
      }
      data.$indexSet(data, "currentLocation", J.get$title$x(this.player.location));
      data.$indexSet(data, "locations", []);
      for (t1 = this.locations.get$keys(), t2 = t1._map, t1 = H.setRuntimeTypeInfo(new P.LinkedHashMapKeyIterator(t2, t2._modifications, null, null), [H.getTypeArgumentByIndex(t1, 0)]), t1._cell = t1._map._first; t1.moveNext$0();) {
        $location = t1._collection$_current;
        t2 = this.locations;
        t2 = t2.$index(t2, $location).get$inanimates();
        t3 = new P._SplayTreeKeyIterable(t2);
        t3.$builtinTypeInfo = [H.getTypeArgumentByIndex(t2, 0)];
        t4 = [];
        t4.$builtinTypeInfo = [P._SplayTreeNode];
        t4 = new P._SplayTreeKeyIterator(t2, t4, t2._modificationCount, t2._splayCount, null);
        t4.$builtinTypeInfo = [H.getTypeArgumentByIndex(t3, 0)];
        t4._findLeftMostDescendent$1(t2._root);
        for (; t4.moveNext$0();) {
          inanimate = t4.get$current();
          t2 = this.locations;
          t2 = t2.$index(t2, $location).get$inanimates();
          t2 = t2.$index(t2, inanimate);
          t3 = J.getInterceptor(t2);
          if (typeof t2 === "object" && t2 !== null && !!t3.$isTakeable) {
            t2 = data.$index(data, "locations");
            t3 = this.locations;
            t3 = t3.$index(t3, $location).get$inanimates();
            J.add$1$ax(t2, [$location, inanimate, t3.$index(t3, inanimate).get$taken()]);
          }
        }
      }
      this.store.saveData$1(data);
      return "Game saved.";
    },
    Game$0: function() {
      var t1, t2, t3, t4, t5, t6, t7, t8;
      t1 = new Q.View(null, null, null, null, null, null, null, null, null);
      t1.View$0();
      this.view = t1;
      t1 = new Q.IndexedDBStorage(null, null);
      t1._gameData = P.LinkedHashMap_LinkedHashMap(null, null, null, null, null);
      this.store = t1;
      t2 = window;
      J.open$3$onUpgradeNeeded$version$x(t2.indexedDB || t2.webkitIndexedDB || t2.mozIndexedDB, "adventureDB", t1.get$_initializeDatabase(), 1).then$1(t1.get$_loadFromDB());
      this.location0 = Q.Location0$(this);
      t1 = new Q.Location1(null, this, null, null, null, null);
      t1.Location$1(this);
      t1.title = "A long dark tunnel";
      t1._description = "You are looking down a long dark tunnel. \n           Behind you, light streams in from the cave entrance to the east.";
      this.location1 = t1;
      t1 = new Q.Location2(this, null, null, null, null);
      t1.Location$1(this);
      this.location2 = t1;
      t1 = new Q.Location3(this, null, null, null, null);
      t1.Location$1(this);
      this.location3 = t1;
      t1 = new Q.Location4(this, null, null, null, null);
      t1.Location$1(this);
      this.location4 = t1;
      t2 = this.location0;
      t3 = t2.title;
      ...
      t7 = t6.title;
      t8 = this.location3;
      t1 = H.fillLiteralMap([t3, t2, t5, t4, t7, t6, t8.title, t8, t1.title, t1], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      this.locations = t1;
      for (t1 = t1.get$values(t1), t2 = t1._iterable, t1 = H.setRuntimeTypeInfo(new H.MappedIterator(null, t2.get$iterator(t2), t1._f), [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]); t1.moveNext$0();)
        t1._current.setupExits$0();
      t1 = this.location0;
      t2 = new Q.Player(null, null, null, null, null, null, null, null, t1);
      t2.Player$1(t1);
      this.player = t2;
      this.updateView$0();
      this.commands = [];
      this.readyCommands$0();
      t2 = this.view;
      t1 = t2.change_notifier$ChangeNotifier$_changes;
      if (t1 == null) {
        t1 = t2.get$observed();
        t1 = P.StreamController_StreamController$broadcast(t2.get$unobserved(), t1, true, null);
        t2.change_notifier$ChangeNotifier$_changes = t1;
      }
      t1.toString;
      H.setRuntimeTypeInfo(new P._BroadcastStream(t1), [H.getTypeArgumentByIndex(t1, 0)]).listen$1(new Q.Game_closure(this));
    },
    static: {Game$: function() {
        var t1 = new Q.Game(null, null, null, null, null, null, null, null, null, null, null);
        t1.Game$0();
        return t1;
      }}
  },
  Game_closure: {
    ...
    call$1: function(records) {
      var t1, t2, t3, firstWord, t4;
      t1 = this.this_0;
      t2 = t1.view._currentInput;
      t3 = J.getInterceptor$asx(t2);
      firstWord = t3.$index(t2, 0);
      if (J.$gt$n(t3.get$length(t2), 1))
        t3.$index(t2, 1);
      t3 = J.contains$1$asx(t1.commands, firstWord);
      t4 = t1.view;
      if (t3 === true) {
        t4.set$text(t4, t1.evaluateCommand$1(t2));
        t2 = t1.view.pageTitle.textContent;
        t3 = J.get$title$x(t1.player.location);
        if (t2 == null ? t3 != null : t2 !== t3) {
          t2 = t1.view;
          t2.set$title(t2, J.get$title$x(t1.player.location));
        }
      } else
        t4.set$text(t4, "I don't understand \"" + H.S(firstWord) + "\".");
    }
  },
  Game_readyCommands_closure: {
    "": "Closure:15;this_0",
    call$1: function(jsonString) {
      this.this_0.commands = J.$index$asx(C.C_JsonCodec.decode$1(jsonString), "commands");
    }
  },
  Game_load_closure: {
    "": "Closure:11;item_0",
    call$0: function() {
      ...
      t1 = this.item_0;
      t2 = J.getInterceptor$asx(t1);
      return new Q.Inanimate(t2.$index(t1, 1), t2.$index(t1, 2), false);
    }
  },
  Inanimate: {
    "": "Object;examineText<,locationText<,taken@",
    $isInanimate: true
  },
  Takeable: {
    "": "Inanimate;examineText,locationText,taken",
    $isTakeable: true
  },
  IndexedDBStorage: {
    "": "Object;_db,_gameData",
    _initializeDatabase$1: [function(e) {
      var objectStore, options;
      objectStore = J.createObjectStore$2$autoIncrement$x(P.convertNativeToDart_AcceptStructuredClone(H.interceptedTypeCast(J.get$target$x(e), "$isRequest").result, false), "adventureStore", true);
      objectStore.toString;
      options = H.fillLiteralMap([], P.LinkedHashMap_LinkedHashMap(null, null, null, null, null));
      options.$indexSet(options, "unique", true);
      J._createIndex$3$x(objectStore, "name_index", "currentLocation", options);
      this.loadData$0();
    }, "call$1", "get$_initializeDatabase", 2, 0, 27],
    _loadFromDB$1: [function(db) {
      this._db = db;
      this.loadData$0();
    }, "call$1", "get$_loadFromDB", 2, 0, 28],
    loadData$0: function() {
      J.openCursor$1$autoAdvance$x(J.objectStore$1$x(J.transaction$2$x(this._db, "adventureStore", "readonly"), "adventureStore"), true).asBroadcastStream$0().listen$1(new Q.IndexedDBStorage_loadData_closure(this));
    },
    saveData$1: function(saveGame) {
      var transaction, t1, objectStore;
      transaction = J.transaction$2$x(this._db, "adventureStore", "readwrite");
      t1 = J.getInterceptor$x(transaction);
      objectStore = t1.objectStore$1(transaction, "adventureStore");
      J.clear$0$ax(t1.objectStore$1(transaction, "adventureStore"));
      J.add$2$ax(objectStore, saveGame, "save").then$1(new Q.IndexedDBStorage_saveData_closure(this, saveGame));
    },
    static: {"": "IndexedDBStorage_ADVENTURE_STORE,IndexedDBStorage_NAME_INDEX"}
  },
  IndexedDBStorage_loadData_closure: {
    "": "Closure:13;this_0",
    call$1: function(cursor) {
      ...
      t2 = t1._gameData;
      t2.clear$0(t2);
      t1._gameData.putIfAbsent$2(J.get$key$x(cursor), new Q.IndexedDBStorage_loadData__closure(cursor));
    }
  },
  IndexedDBStorage_loadData__closure: {
    "": "Closure:11;cursor_1",
    call$0: function() {
      return J.get$value$x(this.cursor_1);
    }
  },
  IndexedDBStorage_saveData_closure: {
    "": "Closure:13;this_0,saveGame_1",
    call$1: function(addedKey) {
      this.this_0._gameData.putIfAbsent$2(addedKey, new Q.IndexedDBStorage_saveData__closure(this.saveGame_1));
    }
  },
  IndexedDBStorage_saveData__closure: {
    "": "Closure:11;saveGame_2",
    call$0: function() {
      return this.saveGame_2;
    }
  },
  Location5: {
    "": "Object;inanimates<,exits<,title>",
    setupExits$0: function() {
      return;
    },
    text$0: function(_) {
      var text, list, t1, t2, t3, inanimate;
      text = this._description;
      list = [];
      for (t1 = this.inanimates, t1 = H.setRuntimeTypeInfo(new P._SplayTreeValueIterable(t1), [H.getTypeArgumentByIndex(t1, 0), H.getTypeArgumentByIndex(t1, 1)]), t2 = t1._map, t3 = H.getTypeArgumentByIndex(t1, 1), t1 = H.setRuntimeTypeInfo(new P._SplayTreeValueIterator(t2, H.setRuntimeTypeInfo([], [P._SplayTreeNode]), t2._modificationCount, t2._splayCount, null), [H.getTypeArgumentByIndex(t1, 0), t3]), t1._SplayTreeIterator$1(t2, t3); t1.moveNext$0();) {
        inanimate = t1.get$current();
        if (!C.JSArray_methods.contains$1(list, inanimate)) {
          list.push(inanimate);
          t2 = J.getInterceptor(inanimate);
          if (typeof inanimate !== "object" || inanimate === null || !t2.$isTakeable) {
            t2 = inanimate.get$locationText();
            if (typeof text !== "string")
              return text.$add();
            text = C.JSString_methods.$add(text, t2);
          } else if (inanimate.taken !== true) {
            t2 = inanimate.locationText;
            if (typeof text !== "string")
              return text.$add();
            text = C.JSString_methods.$add(text, t2);
          }
    ...
    Location$1: function(game) {
      this.inanimates = P.SplayTreeMap$(null, null, J.JSString, Q.Inanimate);
      this.exits = P.SplayTreeMap$(null, null, J.JSString, Q.Exit);
    }
  },
  Location0: {
    "": "Location5;sign,cave,west,rock,game,inanimates,exits,title,_description",
    setupExits$0: function() {
      this.west = new Q.Exit(this.game.location1);
      this.exits.putIfAbsent$2("cave", new Q.Location0_setupExits_closure(this));
      this.exits.putIfAbsent$2("dungeon", new Q.Location0_setupExits_closure0(this));
      this.exits.putIfAbsent$2("west", new Q.Location0_setupExits_closure1(this));
      this.exits.putIfAbsent$2("w", new Q.Location0_setupExits_closure2(this));
    },
    Location0$1: function(game) {
      this.title = "The entrance";
      this._description = "You are standing at the base of a steep rocky slope. ";
      this.sign = new Q.Inanimate("WARNING! This is a dangeous cave. Enter at your own risk!", "There is a small sign embedded near the cave. ", false);
      this.inanimates.putIfAbsent$2("sign", new Q.Location0_closure(this));
      this.cave = new Q.Inanimate("A dark, mysterious cave entrance.", "To the west is the entrance to a cave. ", false);
      this.inanimates.putIfAbsent$2("cave", new Q.Location0_closure0(this));
      this.rock = new Q.Takeable("A sharp rock.", "A particularly sharp rock lies on the ground. ", false);
      this.inanimates.putIfAbsent$2("rock", new Q.Location0_closure1(this));
    },
    static: {Location0$: function(game) {
        var t1 = new Q.Location0(null, null, null, null, game, null, null, null, null);
        t1.Location$1(game);
        t1.Location0$1(game);
        return t1;
      }}
  ...
  Location0_closure: {
    "": "Closure:11;this_0",
    call$0: function() {
      return this.this_0.sign;
    }
  },
  Location0_closure0: {
    "": "Closure:11;this_1",
    call$0: function() {
      return this.this_1.cave;
    }
  },
  Location0_closure1: {
    "": "Closure:11;this_2",
    call$0: function() {
      return this.this_2.rock;
    }
  },
  Location0_setupExits_closure: {
    "": "Closure:11;this_0",
    call$0: function() {
      return this.this_0.west;
    }
  },
  Location0_setupExits_closure0: {
    "": "Closure:11;this_1",
    call$0: function() {
      return this.this_1.west;
    }
  },
  Location0_setupExits_closure1: {
    "": "Closure:11;this_2",
    call$0: function() {
      return this.this_2.west;
    }
  },
  Location0_setupExits_closure2: {
    "": "Closure:11;this_3",
    call$0: function() {
      return this.this_3.west;
    }
  },
  Location1: {
    "": "Location5;east,game,inanimates,exits,title,_description",
    setupExits$0: function() {
      this.east = new Q.Exit(this.game.location0);
      this.exits.putIfAbsent$2("cave", new Q.Location1_setupExits_closure(this));
      this.exits.putIfAbsent$2("entrance", new Q.Location1_setupExits_closure0(this));
      this.exits.putIfAbsent$2("east", new Q.Location1_setupExits_closure1(this));
      this.exits.putIfAbsent$2("e", new Q.Location1_setupExits_closure2(this));
    }
  },
  Location1_setupExits_closure: {
    "": "Closure:11;this_0",
    call$0: function() {
      return this.this_0.east;
    }
  },
  Location1_setupExits_closure0: {
    "": "Closure:11;this_1",
    call$0: function() {
      return this.this_1.east;
    }
  },
  Location1_setupExits_closure1: {
    "": "Closure:11;this_2",
    call$0: function() {
      return this.this_2.east;
    }
  },
  Location1_setupExits_closure2: {
    "": "Closure:11;this_3",
    call$0: function() {
      return this.this_3.east;
    }
  },
  Location2: {
    "": "Location5;game,inanimates,exits,title,_description"
  },
  Location3: {
    "": "Location5;game,inanimates,exits,title,_description"
  },
  ...
  View: {
    "": "ChangeNotifier;enterButton,inputField,descriptionBox,description,pageTitle,roomName,_currentInput,change_notifier$ChangeNotifier$_changes,change_notifier$ChangeNotifier$_records",
    get$currentInput: [function() {
      return this._currentInput;
    }, null, null, 1, 0, 11, "currentInput", 29],
    set$currentInput: [function(value) {
      this._currentInput = F.notifyPropertyChangeHelper(this, C.Symbol_currentInput, this._currentInput, value);
    }, null, null, 3, 0, 13, 30, "currentInput", 29],
    handleKeyEvent$1: [function($event) {
      var keyEvent = new W.KeyEvent(null, null, null, null, null, $event);
      keyEvent.KeyEvent$wrap$1($event);
      if (keyEvent._shadowKeyCode === 13)
        this.handleInput$0();
    }, "call$1", "get$handleKeyEvent", 2, 0, 31],
    handleMouseEvent$1: [function($event) {
      this.handleInput$0();
    }, "call$1", "get$handleMouseEvent", 2, 0, 32],
    handleInput$0: function() {
      var t1 = C.JSString_methods.trim$0(J.toLowerCase$0$s(J.get$value$x(this.inputField)));
      t1 = H.stringReplaceAllUnchecked(t1, " a ", " ");
      t1 = H.stringReplaceAllUnchecked(t1, " an ", " ");
      t1 = H.stringReplaceAllUnchecked(t1, " to ", " ");
      t1 = H.stringReplaceAllUnchecked(t1, " the ", " ");
      t1 = H.stringReplaceAllUnchecked(t1, " into ", " ");
      t1 = H.stringReplaceAllUnchecked(t1, " in ", " ").split(" ");
      this._currentInput = F.notifyPropertyChangeHelper(this, C.Symbol_currentInput, this._currentInput, t1);
      J.set$value$x(this.inputField, "");
    },
    ...
    set$title: function(_, title) {
      ...
      if (title != null && true) {
        this.pageTitle.textContent = string;
        this.roomName.textContent = string;
      }
    },
    set$text: function(_, text) {
      var p, t1;
      p = document.createElement("p", null);
      J.set$innerHtml$x(p, text);
      p.id = "description";
      t1 = J.get$children$x(this.descriptionBox);
      t1.add$1(t1, p);
      t1 = this.descriptionBox;
      t1.scrollTop = t1.scrollHeight;
    },
    View$0: function() {
      var t1 = document.querySelector("#button");
      this.enterButton = t1;
      t1.toString;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_click._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$handleMouseEvent()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
      t1 = document.querySelector("#input");
      this.inputField = t1;
      t1.toString;
      t1 = H.setRuntimeTypeInfo(new W._ElementEventStreamImpl(t1, C.EventStreamProvider_keypress._eventType, false), [null]);
      H.setRuntimeTypeInfo(new W._EventStreamSubscription(0, t1._html$_target, t1._eventType, W._wrapZone(this.get$handleKeyEvent()), t1._useCapture), [H.getTypeArgumentByIndex(t1, 0)])._tryResume$0();
...
["observe.src.change_notifier", "package:observe/src/change_notifier.dart", , O, {
  ...
  ChangeNotifier: {
    ...
    observed$0: [function() {
      return;
    }, "call$0", "get$observed", 0, 0, 0],
    unobserved$0: [function() {
      this.change_notifier$ChangeNotifier$_changes = null;
    }, "call$0", "get$unobserved", 0, 0, 0],
    deliverChanges$0: [function() {
      var records, t1, t2;
      records = this.change_notifier$ChangeNotifier$_records;
      this.change_notifier$ChangeNotifier$_records = null;
      ...
      return false;
    }, "call$0", "get$deliverChanges", 0, 0, 36],
    ...
    notifyChange$1: function(record) {
      ...
      if (!t1)
        return;
      if (this.change_notifier$ChangeNotifier$_records == null) {
        this.change_notifier$ChangeNotifier$_records = [];
        P.scheduleMicrotask(this.get$deliverChanges());
      }
      this.change_notifier$ChangeNotifier$_records.push(record);
    }
  }
}],
...
Q.Inanimate.$isObject = true;
Q.Exit.$isObject = true;
...
J.createObjectStore$2$autoIncrement$x = function(receiver, a0, a1) {
  return J.getInterceptor$x(receiver).createObjectStore$2$autoIncrement(receiver, a0, a1);
};
...
C.Symbol_currentInput = new H.Symbol("currentInput");
...
$.interceptedNames = ["$add", "$eq", "$ge", "$gt", "$index", "$indexSet", "$lt", "$shl", "$sub", "__isolate_helper$_add$1", "_add$1", "_async$_add$1", "_createIndex$3", "_createObjectStore$2", "_getKey$0", "_indexed_db$_add$1", "_indexed_db$_add$2", "_invalidIndex$2", "_replaceChild$2", "_shrOtherPositive$1", "_tdivFast$1", "add$1", "add$2", "addAll$1", "addEventListener$3", "allMatches$1", "any$1", "clear$0", "close$0", "codeUnitAt$1", "compareTo$1", "complete$0", "complete$1", "contains$1", "contains$2", "createFragment$2$treeSanitizer", "createFragment$3$treeSanitizer$validator", "createObjectStore$2$autoIncrement", "createObjectStore$3$autoIncrement$keyPath", "elementAt$1", "error$1", "forEach$1", "get$attributes", "get$children", "get$currentTarget", "get$error", "get$hashCode", "get$hostname", "get$isEmpty", "get$isNaN", "get$isNegative", "get$isNotEmpty", "get$iterator", "get$key", "get$length", "get$location", "get$name", "get$next", "get$nodes", "get$onBlocked", "get$onUpgradeNeeded", "get$port", "get$protocol", "get$responseText", "get$single", "get$tagName", "get$target", "get$title", "get$value", "get$values", "indexOf$2", "load$0", "matchAsPrefix$2", "next$0", "next$1", "objectStore$1", "onError$1", "open$3$async", "open$3$onUpgradeNeeded$version", "open$4$onBlocked$onUpgradeNeeded$version", "open$5$async$password$user", "openCursor$1$autoAdvance", "openCursor$4$autoAdvance$direction$key$range", "pause$0", "pause$1", "register$2", "remainder$1", "remove$0", "remove$1", "removeEventListener$3", "removeRange$2", "replaceWith$1", "reset$0", "send$1", "send$2", "set$href", "set$innerHtml", "set$length", "set$next", "set$text", "set$title", "set$value", "setInnerHtml$1", "setInnerHtml$3$treeSanitizer$validator", "startsWith$1", "startsWith$2", "sublist$2", "substring$1", "substring$2", "text$0", "toInt$0", "toList$0", "toList$1$growable", "toLowerCase$0", "toString$0", "transaction$2", "trim$0", "where$1"];
...
{func: "void__Database", void: true, args: [P.Database]},
C.C_Reflectable,
"value",
...
function dart_precompiled($collectedClasses) {
  ...
  function _BroadcastStreamController(_onListen, _onCancel, _next, _previous) {
  ...
  Attack.builtin$cls = "Attack";
  if (!"name" in Attack)
    Attack.name = "Attack";
  $desc = $collectedClasses.Attack;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Attack.prototype = $desc;
  function Move() {
  }
  Move.builtin$cls = "Move";
  if (!"name" in Move)
    Move.name = "Move";
  $desc = $collectedClasses.Move;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Move.prototype = $desc;
  function Examine() {
  }
  Examine.builtin$cls = "Examine";
  if (!"name" in Examine)
    Examine.name = "Examine";
  $desc = $collectedClasses.Examine;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Examine.prototype = $desc;
  function Take() {
  }
  Take.builtin$cls = "Take";
  if (!"name" in Take)
    Take.name = "Take";
  $desc = $collectedClasses.Take;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Take.prototype = $desc;
  function Take_execute_closure(item_0) {
    this.item_0 = item_0;
  }
  Take_execute_closure.builtin$cls = "Take_execute_closure";
  if (!"name" in Take_execute_closure)
    Take_execute_closure.name = "Take_execute_closure";
  $desc = $collectedClasses.Take_execute_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Take_execute_closure.prototype = $desc;
  ...
  Animate.prototype.get$location = function(receiver) {
    return this.location;
  };
  function Player(hp, defense, inventory, currentAction, examine, take, attack, move, location) {
    this.hp = hp;
  ...
  Exit.builtin$cls = "Exit";
  if (!"name" in Exit)
    Exit.name = "Exit";
  $desc = $collectedClasses.Exit;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Exit.prototype = $desc;
  Exit.prototype.get$location = function(receiver) {
    return this.location;
  };
  function Game(view, player, store, currentLocation, location0, location1, location2, location3, location4, locations, commands) {
    this.view = view;
    this.player = player;
    this.store = store;
  ...
  function Game_readyCommands_closure(this_0) {
    this.this_0 = this_0;
  }
  Game_readyCommands_closure.builtin$cls = "Game_readyCommands_closure";
  if (!"name" in Game_readyCommands_closure)
    Game_readyCommands_closure.name = "Game_readyCommands_closure";
  $desc = $collectedClasses.Game_readyCommands_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_readyCommands_closure.prototype = $desc;
  function Game_load_closure(item_0) {
    this.item_0 = item_0;
  }
  Game_load_closure.builtin$cls = "Game_load_closure";
  if (!"name" in Game_load_closure)
    Game_load_closure.name = "Game_load_closure";
  $desc = $collectedClasses.Game_load_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Game_load_closure.prototype = $desc;
  function Inanimate(examineText, locationText, taken) {
    this.examineText = examineText;
    this.locationText = locationText;
    this.taken = taken;
  }
  Inanimate.builtin$cls = "Inanimate";
  if (!"name" in Inanimate)
    Inanimate.name = "Inanimate";
  $desc = $collectedClasses.Inanimate;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Inanimate.prototype = $desc;
  Inanimate.prototype.get$examineText = function() {
    return this.examineText;
  };
  Inanimate.prototype.get$locationText = function() {
    return this.locationText;
  };
  Inanimate.prototype.get$taken = function() {
    return this.taken;
  };
  Inanimate.prototype.set$taken = function(v) {
    return this.taken = v;
  };
  function Takeable(examineText, locationText, taken) {
    this.examineText = examineText;
    this.locationText = locationText;
    this.taken = taken;
  }
  Takeable.builtin$cls = "Takeable";
  if (!"name" in Takeable)
    Takeable.name = "Takeable";
  $desc = $collectedClasses.Takeable;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Takeable.prototype = $desc;
  function IndexedDBStorage(_db, _gameData) {
    this._db = _db;
    this._gameData = _gameData;
  }
  IndexedDBStorage.builtin$cls = "IndexedDBStorage";
  if (!"name" in IndexedDBStorage)
    IndexedDBStorage.name = "IndexedDBStorage";
  $desc = $collectedClasses.IndexedDBStorage;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexedDBStorage.prototype = $desc;
  function IndexedDBStorage_loadData_closure(this_0) {
    this.this_0 = this_0;
  }
  IndexedDBStorage_loadData_closure.builtin$cls = "IndexedDBStorage_loadData_closure";
  if (!"name" in IndexedDBStorage_loadData_closure)
    IndexedDBStorage_loadData_closure.name = "IndexedDBStorage_loadData_closure";
  $desc = $collectedClasses.IndexedDBStorage_loadData_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexedDBStorage_loadData_closure.prototype = $desc;
  function IndexedDBStorage_loadData__closure(cursor_1) {
    this.cursor_1 = cursor_1;
  }
  IndexedDBStorage_loadData__closure.builtin$cls = "IndexedDBStorage_loadData__closure";
  if (!"name" in IndexedDBStorage_loadData__closure)
    IndexedDBStorage_loadData__closure.name = "IndexedDBStorage_loadData__closure";
  $desc = $collectedClasses.IndexedDBStorage_loadData__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexedDBStorage_loadData__closure.prototype = $desc;
  function IndexedDBStorage_saveData_closure(this_0, saveGame_1) {
    this.this_0 = this_0;
    this.saveGame_1 = saveGame_1;
  }
  IndexedDBStorage_saveData_closure.builtin$cls = "IndexedDBStorage_saveData_closure";
  if (!"name" in IndexedDBStorage_saveData_closure)
    IndexedDBStorage_saveData_closure.name = "IndexedDBStorage_saveData_closure";
  $desc = $collectedClasses.IndexedDBStorage_saveData_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexedDBStorage_saveData_closure.prototype = $desc;
  function IndexedDBStorage_saveData__closure(saveGame_2) {
    this.saveGame_2 = saveGame_2;
  }
  IndexedDBStorage_saveData__closure.builtin$cls = "IndexedDBStorage_saveData__closure";
  if (!"name" in IndexedDBStorage_saveData__closure)
    IndexedDBStorage_saveData__closure.name = "IndexedDBStorage_saveData__closure";
  $desc = $collectedClasses.IndexedDBStorage_saveData__closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  IndexedDBStorage_saveData__closure.prototype = $desc;
  function Location5(inanimates, exits, title) {
    this.inanimates = inanimates;
    this.exits = exits;
    this.title = title;
  }
  Location5.builtin$cls = "Location5";
  if (!"name" in Location5)
    Location5.name = "Location5";
  $desc = $collectedClasses.Location5;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location5.prototype = $desc;
  Location5.prototype.get$inanimates = function() {
    return this.inanimates;
  };
  Location5.prototype.get$exits = function() {
    return this.exits;
  };
  Location5.prototype.get$title = function(receiver) {
    return this.title;
  };
  function Location0(sign, cave, west, rock, game, inanimates, exits, title, _description) {
    this.sign = sign;
    this.cave = cave;
    this.west = west;
    this.rock = rock;
  ...
  $desc = $collectedClasses.Location0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0.prototype = $desc;
  function Location0_closure(this_0) {
    this.this_0 = this_0;
  }
  Location0_closure.builtin$cls = "Location0_closure";
  if (!"name" in Location0_closure)
    Location0_closure.name = "Location0_closure";
  $desc = $collectedClasses.Location0_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0_closure.prototype = $desc;
  function Location0_closure0(this_1) {
    this.this_1 = this_1;
  }
  Location0_closure0.builtin$cls = "Location0_closure0";
  if (!"name" in Location0_closure0)
    Location0_closure0.name = "Location0_closure0";
  $desc = $collectedClasses.Location0_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0_closure0.prototype = $desc;
  function Location0_closure1(this_2) {
    this.this_2 = this_2;
  }
  Location0_closure1.builtin$cls = "Location0_closure1";
  if (!"name" in Location0_closure1)
    Location0_closure1.name = "Location0_closure1";
  $desc = $collectedClasses.Location0_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0_closure1.prototype = $desc;
  function Location0_setupExits_closure(this_0) {
    this.this_0 = this_0;
  }
  Location0_setupExits_closure.builtin$cls = "Location0_setupExits_closure";
  if (!"name" in Location0_setupExits_closure)
    Location0_setupExits_closure.name = "Location0_setupExits_closure";
  $desc = $collectedClasses.Location0_setupExits_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0_setupExits_closure.prototype = $desc;
  function Location0_setupExits_closure0(this_1) {
    this.this_1 = this_1;
  }
  Location0_setupExits_closure0.builtin$cls = "Location0_setupExits_closure0";
  if (!"name" in Location0_setupExits_closure0)
    Location0_setupExits_closure0.name = "Location0_setupExits_closure0";
  $desc = $collectedClasses.Location0_setupExits_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0_setupExits_closure0.prototype = $desc;
  function Location0_setupExits_closure1(this_2) {
    this.this_2 = this_2;
  }
  Location0_setupExits_closure1.builtin$cls = "Location0_setupExits_closure1";
  if (!"name" in Location0_setupExits_closure1)
    Location0_setupExits_closure1.name = "Location0_setupExits_closure1";
  $desc = $collectedClasses.Location0_setupExits_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0_setupExits_closure1.prototype = $desc;
  function Location0_setupExits_closure2(this_3) {
    this.this_3 = this_3;
  }
  Location0_setupExits_closure2.builtin$cls = "Location0_setupExits_closure2";
  if (!"name" in Location0_setupExits_closure2)
    Location0_setupExits_closure2.name = "Location0_setupExits_closure2";
  $desc = $collectedClasses.Location0_setupExits_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location0_setupExits_closure2.prototype = $desc;
  function Location1(east, game, inanimates, exits, title, _description) {
    this.east = east;
    this.game = game;
    this.inanimates = inanimates;
    this.exits = exits;
  ...
  Location1.builtin$cls = "Location1";
  if (!"name" in Location1)
    Location1.name = "Location1";
  $desc = $collectedClasses.Location1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location1.prototype = $desc;
  function Location1_setupExits_closure(this_0) {
    this.this_0 = this_0;
  }
  Location1_setupExits_closure.builtin$cls = "Location1_setupExits_closure";
  if (!"name" in Location1_setupExits_closure)
    Location1_setupExits_closure.name = "Location1_setupExits_closure";
  $desc = $collectedClasses.Location1_setupExits_closure;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location1_setupExits_closure.prototype = $desc;
  function Location1_setupExits_closure0(this_1) {
    this.this_1 = this_1;
  }
  Location1_setupExits_closure0.builtin$cls = "Location1_setupExits_closure0";
  if (!"name" in Location1_setupExits_closure0)
    Location1_setupExits_closure0.name = "Location1_setupExits_closure0";
  $desc = $collectedClasses.Location1_setupExits_closure0;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location1_setupExits_closure0.prototype = $desc;
  function Location1_setupExits_closure1(this_2) {
    this.this_2 = this_2;
  }
  Location1_setupExits_closure1.builtin$cls = "Location1_setupExits_closure1";
  if (!"name" in Location1_setupExits_closure1)
    Location1_setupExits_closure1.name = "Location1_setupExits_closure1";
  $desc = $collectedClasses.Location1_setupExits_closure1;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location1_setupExits_closure1.prototype = $desc;
  function Location1_setupExits_closure2(this_3) {
    this.this_3 = this_3;
  }
  Location1_setupExits_closure2.builtin$cls = "Location1_setupExits_closure2";
  if (!"name" in Location1_setupExits_closure2)
    Location1_setupExits_closure2.name = "Location1_setupExits_closure2";
  $desc = $collectedClasses.Location1_setupExits_closure2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location1_setupExits_closure2.prototype = $desc;
  function Location2(game, inanimates, exits, title, _description) {
    this.game = game;
    this.inanimates = inanimates;
    this.exits = exits;
    this.title = title;
  ...
  Location2.builtin$cls = "Location2";
  if (!"name" in Location2)
    Location2.name = "Location2";
  $desc = $collectedClasses.Location2;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location2.prototype = $desc;
  function Location3(game, inanimates, exits, title, _description) {
    this.game = game;
    this.inanimates = inanimates;
    this.exits = exits;
    this.title = title;
  ...
  Location3.builtin$cls = "Location3";
  if (!"name" in Location3)
    Location3.name = "Location3";
  $desc = $collectedClasses.Location3;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location3.prototype = $desc;
  function Location4(game, inanimates, exits, title, _description) {
    this.game = game;
    this.inanimates = inanimates;
    this.exits = exits;
    this.title = title;
  ...
  Location4.builtin$cls = "Location4";
  if (!"name" in Location4)
    Location4.name = "Location4";
  $desc = $collectedClasses.Location4;
  if ($desc instanceof Array)
    $desc = $desc[1];
  Location4.prototype = $desc;
  function View(enterButton, inputField, descriptionBox, description, pageTitle, roomName, _currentInput, change_notifier$ChangeNotifier$_changes, change_notifier$ChangeNotifier$_records) {
